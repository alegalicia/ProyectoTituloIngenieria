...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-12-2021 a las 17:43:50
...
INSERT INTO `alertas` (`id_alertas`, `id_sensor`, `mensaje`, `fecha`, `hora`, `estado`) VALUES
(1, 1, 'mensaje', '2021-10-05', '13:36:27', 1);
...
(0, '3', 'cbcv', 'cbcv', '2021-12-31', '2021-12-31', '2021-12-31', '14', 'S/D1', '2021-10-16', '2021-10-16', 1),
...
(3, '3', 'Nicolas', 'Ramirez', '1990-10-10', '123', '123', '123@123.co', '123', '0000-00-00', '0000-00-00', 1),
...
(4, 1, 1, '60', '2005-05-05', '05:05:05', 0),
(5, 1, 1, '80', '2005-05-05', '05:05:05', 0),
(6, 1, 1, '60', '2005-05-05', '05:05:05', 0),
(7, 1, 2, '20', '2005-05-05', '05:05:05', 0),
(8, 1, 1, '70', '2005-05-05', '05:05:05', 0);
...
--
ALTER TABLE `alertas`
  MODIFY `id_alertas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `registros_monitoreo`
  MODIFY `id_registros_monitoreo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tipos_registros`
  MODIFY `id_tipos_registros` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
